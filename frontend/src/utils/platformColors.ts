...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'aws'
...
const BADGE: Record<Platform, string> = {
  ...
  aws: 'bg-amber-500/10 text-amber-600 border-amber-500/30 dark:text-amber-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  aws: 'bg-amber-500/10 text-amber-600 dark:bg-amber-500/10 dark:text-amber-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  aws: 'border-amber-500/20 dark:border-amber-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  aws: 'bg-gradient-to-r from-amber-400 to-amber-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  aws: 'text-amber-600 dark:text-amber-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  aws: 'text-amber-500 dark:text-amber-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  aws: 'bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 dark:bg-amber-500/80 dark:hover:bg-amber-500',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'aws'
}
