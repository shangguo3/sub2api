...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'aws'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'aws'
export type AccountType = 'oauth' | 'setup-token' | 'apikey' | 'upstream' | 'bedrock' | 'service_account' | 'iam_role' | 'aws_sso'
